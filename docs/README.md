...
| [c1.md](c1.md) | `c1` + codegen table | compiler pass 2 (PDP-11 codegen) | done (incl. FP11 float codegen) |
| [c2.md](c2.md) | `c2` | peephole optimizer | done; `cc -O` produces correct, smaller code |
| [as.md](as.md) | `as` | assembler (C reimplementation) | done (incl. local labels, multi-file, EIS, FP11) |
...
| [libc.md](libc.md) | libc + crt0 | runtime (authentic 2.8BSD libc) | done: 107 members (string, stdio, file I/O, ~40 syscalls, long arith) |
| [apsim.md](apsim.md) | `apsim` | host-side PDP-11 simulator | verification aid (runs output, incl. FP11 floats) |
