...
#ifdef	UCB_BUFOUT
extern struct buf abuf[];		/* The in-address-space buffer list */
extern struct buf abfreelist;		/* head of available list */
#endif
...
#ifdef UCB_BHASH
#define	B_CACHE	04000	/* did bread find this block in cache? */
#else
