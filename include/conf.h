...
#define TIMEST	 1l <<  8 /* TIME STring ie. 10:00-12:00 (Checkout)	*/
#define NOTNUL	 1l <<  9 /* give error if field is null (Checkout)	*/
#define DICT	 1l << 10 /* DICTionary verification field (Checkout)	*/
